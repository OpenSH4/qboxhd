...
#else
		uint8_t cellIdExtension;
		uint16_t subcellLatitude;
		uint16_t subcellLongitude;
		uint16_t subcellExtendOfLatitude;
		uint16_t subcellExtendOfLongitude;
#endif
...
#else
		uint16_t cellId;
		uint16_t cellLatitude;
		uint16_t cellLongtitude;
		uint16_t cellExtendOfLatitude;
		uint16_t cellExtendOfLongtitude;
		uint8_t subcellInfoLoopLength;
#endif
