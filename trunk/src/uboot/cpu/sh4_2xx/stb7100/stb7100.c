...
#define MII_MODE            0x00040000 /* MII interface activated */
...
/* Duolabs: we need it to set the speed of internal mac */
...
#else
	sysconf |= (DVO_ETH_PAD_DISABLE | ETH_IF_ON | PHY_CLK_EXT);
#endif
