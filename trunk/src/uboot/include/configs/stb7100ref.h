...
//#define CFG_FLASH_BASE	0xA0010000
//#define CFG_RESET_ADDRESS	0xA0010000

#define CFG_MONITOR_LEN		0x0005F000	/* Reserve 512 kB -4kB for env */

//Duolabs
#define CFG_MONITOR_BASE        0xA0000000 
//#define CFG_MONITOR_BASE        0xA0010000 
...
#define	CONFIG_EXTRA_ENV_SETTINGS \
		...
		"monitor_base=" XSTR(CFG_MONITOR_BASE) "\0" \
		"monitor_len=" XSTR(CFG_MONITOR_LEN) "\0" \
		"monitor_sec=1:0-31\0" \
		"load_addr=" XSTR(CFG_LOAD_ADDR) "\0" \
		"unprot= " \
		  "protect off $monitor_sec\0" \
		"update=" \
		  "protect off $monitor_sec;" \
		  "erase $monitor_sec;" \
...
//il DHCP crea problemi con la ricezione del broadcast
#define CONFIG_COMMANDS	(CONFIG_CMD_DFL | \
			 CFG_CMD_ASKENV  | \
			 CFG_CMD_NFS | CFG_CMD_PING | CFG_CMD_DHCP| \
			 CFG_CMD_IDE | CFG_CMD_EXT2 | CFG_CMD_NET )
...
#define CFG_PROMPT		"[u-boot@qbox-hd]>"	/* Monitor Command Prompt	*/
...
#define CFG_MAX_FLASH_SECT	2048//64    	/* max number of sectors on one chip 	*/
...
//#define CFG_ENV_OFFSET          0x6F000//0x20000//0x40000//0x20000
//#define CFG_ENV_ADDR            (CFG_FLASH_BASE + CFG_ENV_OFFSET+0x10000)
#define CFG_ENV_OFFSET          0x5F000
#define CFG_ENV_ADDR            0xA005F000

#define CFG_ENV_SIZE            0x1000//0x10000 //4KB for env
#define CFG_ENV_SECT_SIZE       0x1000//0x20000

/*-----------------------------------------------------------------------
 * For Netconsole enable
 */
#define	CONFIG_NETCONSOLE
//#define	CONFIG_NET_MULTI // It is useless
