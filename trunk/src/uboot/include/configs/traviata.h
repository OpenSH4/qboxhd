...
#define CFG_MONITOR_LEN		0x00030000 	/* Reserve 192 kB for Monitor */
...
#define CONFIG_SMC911X_BASE     0x800000ul
...
#define CFG_PROMPT		"Traviata> "	/* Monitor Command Prompt	*/
...
#define CFG_FLASH_CFI_SWAP_ERASE_REGIONS
...
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + 0x7F0000) /* 1st 4 8K sectors */
#define CFG_ENV_SIZE		0x8000 /* 32K */
