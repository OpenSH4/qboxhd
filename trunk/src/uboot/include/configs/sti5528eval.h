...
#define CONFIG_CPU_SUBTYPE_SH4_1XX	/* its an SH4-103 (ST40)                 */

#define INPUT_CLOCK_RATE 27
#define CPU_CLOCK_RATE	200000000	/* 200 MHz clock for the SH4 core */
#define P_CLOCK_RATE     50000000	/* Peripheral clock for SH4 core  */
#define B_CLOCK_RATE    133000000	/* Bus clock for SH4 core         */
...
#define CONFIG_COMMANDS	(CONFIG_CMD_DFL | CMD_ASKENV | \
...
#define	CONFIG_SMC91111_BASE	0xa3020600ul
...
#define CFG_ATA_BASE_ADDR    0xB9140000
...
#define CFG_PROMPT		"STI5528-EVAL> "	/* Monitor Command Prompt       */
...
#define CFG_FLASH_BANKS_LIST { CFG_FLASH_BASE, CFG_FLASH_BASE + 0x1000000 }
...
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + 0x40000)	/* 2nd sector */
