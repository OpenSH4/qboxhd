...
//Duolabs
#include <config.h>
//#define PHY_ADDRESS_CHIP	0x1F
#ifndef CONFIG_QBOXHD_mini
	#define PHY_ADDRESS_CHIP	0x1
#else
	#define PHY_ADDRESS_CHIP	0x1F
#endif
/*----------------------------------------------------------------------------
...
//#define STMAC_WRITE(V, REG) ctrl_outl(V, CONFIG_STMAC_ADDRESS+(REG))
...
#define CONFIG_STMAC_AUTONEG_TIMEOUT  (3*CFG_HZ) /* ticks */ //prova
#endif
