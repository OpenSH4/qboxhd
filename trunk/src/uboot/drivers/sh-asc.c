...
#define UART_BAUDRATE_REG   (CONFIG_SH_ASC_BASE + UART_BAUDRATE_OFFSET)
#define UART_TXBUFFER_REG   (CONFIG_SH_ASC_BASE + UART_TXBUFFER_OFFSET)
#define UART_RXBUFFER_REG   (CONFIG_SH_ASC_BASE + UART_RXBUFFER_OFFSET)
#define UART_CONTROL_REG    (CONFIG_SH_ASC_BASE + UART_CONTROL_OFFSET)
#define UART_INTENABLE_REG  (CONFIG_SH_ASC_BASE + UART_INTENABLE_OFFSET)
#define UART_STATUS_REG     (CONFIG_SH_ASC_BASE + UART_STATUS_OFFSET)
#define UART_GUARDTIME_REG  (CONFIG_SH_ASC_BASE + UART_GUARDTIME_OFFSET)
#define UART_TIMEOUT_REG    (CONFIG_SH_ASC_BASE + UART_TIMEOUT_OFFSET)
#define UART_TXRESET_REG    (CONFIG_SH_ASC_BASE + UART_TXRESET_OFFSET)
#define UART_RXRESET_REG    (CONFIG_SH_ASC_BASE + UART_RXRESET_OFFSET)
#define UART_RETRIES_REG    (CONFIG_SH_ASC_BASE + UART_RETRIES_OFFSET)
