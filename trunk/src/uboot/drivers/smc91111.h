...
#elif defined(CONFIG_SH_STI5528_EVAL)  || defined(CONFIG_STM_MB390)

#define SMC_IO_SHIFT            1
#define SMC_STEM_BS_MASK        3

#ifdef CONFIG_STM_MB390
#define REG_OFFSET(base,reg) ({                         \
	u_int __reg = (reg<<SMC_IO_SHIFT);              \
	__reg = ( (__reg & (~SMC_STEM_BS_MASK))      ) | \
		( (__reg & ( SMC_STEM_BS_MASK)) >> 1 );  \
	__reg += base;                                  \
	__reg; })
...
#define	SMC_inw(r) 	(*((volatile word *)(REG_OFFSET(CONFIG_SMC91111_BASE,r))))
#define	SMC_inb(r) 	(*((volatile byte *)(REG_OFFSET(CONFIG_SMC91111_BASE,r))))
#define	SMC_outw(d,r)	(*((volatile word *)(REG_OFFSET(CONFIG_SMC91111_BASE,r))) = d)
#define	SMC_outb(d,r)	(*((volatile byte *)(REG_OFFSET(CONFIG_SMC91111_BASE,r))) = d)
...
#else /* if not CONFIG_PXA250 & not CONFIG_SH_STI5528_EVAL */
