...
from Screens.InfoBarGenerics import InfoBarShowHide, \
	InfoBarNumberZap, InfoBarChannelSelection, InfoBarMenu, InfoBarCustomButton, InfoBarDelayer, InfoBarRdsDecoder, \
...
class InfoBar(InfoBarBase, InfoBarShowHide,
	InfoBarNumberZap, InfoBarChannelSelection, InfoBarMenu, InfoBarEPG, InfoBarCustomButton, InfoBarDelayer, InfoBarRdsDecoder,
	...
	def __init__(self, session):
		...
		for x in HelpableScreen, \
				...
				InfoBarInstantRecord, InfoBarAudioSelection, InfoBarCustomButton, InfoBarDelayer, \
