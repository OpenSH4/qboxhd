...
class MC_PicThumbViewer(Screen, HelpableScreen):
	def __init__(self, session, piclist, lastindex, path):
		...
		self.skin = "<screen position=\"0,0\" size=\"" + str(size_w) + "," + str(size_h) + "\" flags=\"wfNoBorder\" > \
			<ePixmap name=\"mb_bg\" position=\"0,0\" zPosition=\"1\" size=\""+ str(size_w) + "," + str(size_h) + "\" pixmap=\"/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/skins/" + str(self.skindir) + "/images/bg_picthumbplayer.png\" /> \
			<ePixmap pixmap=\"/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/icons/key-red.png\" position=\"60," + str(self.ButtonPosY) + "\" zPosition=\"2\" size=\"140,40\" transparent=\"1\" alphatest=\"on\" /> \
			<ePixmap pixmap=\"/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/icons/key-green.png\" position=\"210," + str(self.ButtonPosY) + "\" zPosition=\"2\" size=\"140,40\" transparent=\"1\" alphatest=\"on\" /> \
			<ePixmap pixmap=\"/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/icons/key-yellow.png\" position=\"360," + str(self.ButtonPosY) + "\" zPosition=\"2\" size=\"140,40\" transparent=\"1\" alphatest=\"on\" /> \
			<ePixmap pixmap=\"/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/icons/key-blue.png\" position=\"510," + str(self.ButtonPosY) + "\" zPosition=\"2\" size=\"140,40\" transparent=\"1\" alphatest=\"on\" /> \
			...
			<widget name=\"frame\" position=\"35,30\" size=\"" + str(self.picX +1) + "," + str(self.picY +10) + "\" pixmap=\"/usr/lib/enigma2/python/Plugins/Extensions/MediaCenter/icons/pic_frame.png\" zPosition=\"3\" alphatest=\"on\" />"  + skincontent + "</screen>"
