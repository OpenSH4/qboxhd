...
if QBOXHD:
	defaultPaths = {
			...
			SCOPE_PLUGINS: ("/usr/local/lib/enigma2/python/Plugins/", PATH_CREATE),

			SCOPE_LANGUAGE: ("/usr/local/share/enigma2/po/", PATH_DONTCREATE),

			SCOPE_SKIN: ("/usr/local/share/enigma2/", PATH_DONTCREATE),
			SCOPE_SKIN_IMAGE: ("/usr/local/share/enigma2/", PATH_DONTCREATE),
			...
			SCOPE_DEFAULTDIR: ("/usr/local/share/enigma2/defaults/", PATH_CREATE),
			SCOPE_DEFAULTPARTITION: ("/dev/mtdblock/6", PATH_DONTCREATE),
			SCOPE_DEFAULTPARTITIONMOUNTDIR: ("/usr/local/share/enigma2/dealer", PATH_CREATE),
			SCOPE_METADIR: ("/usr/local/share/enigma2/meta", PATH_CREATE),
		}

	fallbackPaths = {
			SCOPE_CONFIG: [("/home/root/", FILE_MOVE),
						("/usr/local/share/enigma2/defaults/", FILE_COPY)],
