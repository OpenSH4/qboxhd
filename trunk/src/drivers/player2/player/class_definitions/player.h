/************************************************************************
COPYRIGHT (C) SGS-THOMSON Microelectronics 2002,2005,2006
...
public:
    ...
    virtual PlayerStatus_t   GetPresentationInterval(   PlayerPlayback_t          Playback,
...
playing out the data already injected, and consequently the call is
non-blocking. The playout nature can be overridden by a current policy.
After this call no more input data will be accepted under the old
stream identifier (unless the old and new stream identifiers are the same).
...
/*! \fn PlayerStatus_t   Player_c::GetPresentationInterval(     PlayerPlayback_t          Playback,
							unsigned long long       *IntervalStartNormalizedTime,
