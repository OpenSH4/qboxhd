...
#define PLAY_OPTION_VALUE_DISCARD_LATE_FRAMES_AFTER_SYNCHRONIZE                      DVB_OPTION_VALUE_DISCARD_LATE_FRAMES_AFTER_SYNCHRONIZE
    ...
    PLAY_OPTION_H264_TREAT_DUPLICATE_DPB_AS_NON_REFERENCE_FRAME_FIRST   = DVP_OPTION_H264_TREAT_DUPLICATE_DPB_AS_NON_REFERENCE_FRAME_FIRST,
} play_option_t;
...
struct dvb_backend_operations
{
    ...
    int (*playback_terminate)          (playback_handle_t       playback);
    ...
    int (*playback_remove_stream)      (playback_handle_t       playback,
                                        stream_handle_t         stream);
    int (*playback_set_play_interval)  (playback_handle_t       playback,
