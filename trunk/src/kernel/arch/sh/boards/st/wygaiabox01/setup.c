...
static void wygaiabox_bpa2_init(void)
{
...
static inline void wygaiabox_bpa2_init(void) { return; }

#endif  /* CONFIG_BPA2 */


void __init wygaiabox01_setup(char **cmdline_p)
{
	extern void wygaiabox_pio_init(void);
 ...
 * I2C
 */
static struct i2c_board_info wygaiabox01_i2c_devices[] __initdata = {
...
static struct spi_board_info wygaiabox01_spi_devices[] __initdata = {
	{
...
static struct platform_device *wygaiabox01_devices[] __initdata = {
	&physmap_flash,
	&stmmac_phy_device,
	&net2272_device,
	&vmii_bus,
...
static int __init wygaiabox01_device_init(void)
{
	...
	i2c_register_board_info(0, wygaiabox01_i2c_devices,
				ARRAY_SIZE(wygaiabox01_i2c_devices));
#if defined(CONFIG_MTD_M25P80) || defined(CONFIG_MTD_M25P80_MODULE)
	spi_register_board_info(wygaiabox01_spi_devices,
	                        ARRAY_SIZE(wygaiabox01_spi_devices));
#endif
	...
	return platform_add_devices(wygaiabox01_devices,
				    ARRAY_SIZE(wygaiabox01_devices));
}

device_initcall(wygaiabox01_device_init);
