/*
 * Machine vector for the Wyplay MediaBox prototype board,
...
static void __iomem* wymdbox01_ioport_map(unsigned long port, unsigned int size)
{
...
static void __init wymdbox01_init_irq(void)
{
...
extern void __init wymdbox01_setup(char **cmdline_p);

struct sh_machine_vector mv_wymdbox01 __initmv = {
	.mv_name	= "Wyplay MediaBox Prototype Board",
	.mv_setup	= wymdbox01_setup,
	.mv_nr_irqs	= NR_IRQS,
	.mv_init_irq	= wymdbox01_init_irq,
	.mv_ioport_map	= wymdbox01_ioport_map,
};
