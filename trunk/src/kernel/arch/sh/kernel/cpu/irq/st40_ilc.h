...
#define ILC_STATUS_REG(_int)         ((unsigned long)ilc_base + 0x200 + _REG_OFF(_int))
#define ILC_CLR_STATUS_REG(_int)     ((unsigned long)ilc_base + 0x280 + _REG_OFF(_int))
#define ILC_ENABLE_REG(_int)         ((unsigned long)ilc_base + 0x400 + _REG_OFF(_int))
#define ILC_CLR_ENABLE_REG(_int)     ((unsigned long)ilc_base + 0x480 + _REG_OFF(_int))
#define ILC_SET_ENABLE_REG(_int)     ((unsigned long)ilc_base + 0x500 + _REG_OFF(_int))
#define ILC_EXT_WAKEUP_EN_REG        ((unsigned long)ilc_base + 0x600)
#define ILC_EXT_WAKPOL_EN_REG        ((unsigned long)ilc_base + 0x680)
#define ILC_PRIORITY_REG(_int)       ((unsigned long)ilc_base + 0x800 + (8 * _int))
#define ILC_TRIGMODE_REG(_int)       ((unsigned long)ilc_base + 0x804 + (8 * _int))
