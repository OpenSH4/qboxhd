...
typedef struct {
     ...
     unsigned long  (*AuxMemoryPhysical)( // CoreSurfaceStorage
                                          unsigned int storage,
                                          unsigned int offset );
     void*          (*AuxMemoryVirtual)( // CoreSurfaceStorage
                                         unsigned int storage,
                                         unsigned int offset );
...
unsigned long
dfb_system_aux_memory_physical( // CoreSurfaceStorage
                                unsigned int storage,
                                unsigned int offset );

void *
dfb_system_aux_memory_virtual( // CoreSurfaceStorage
                               unsigned int storage,
                               unsigned int offset );
