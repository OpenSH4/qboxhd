...
protected:
     IDirectFBDataBuffer(IDirectFBDataBuffer_C *idirectfbdatabuffer);
     ~IDirectFBDataBuffer();

     IDirectFBDataBuffer_C *get_iface() { return iface; }

private:
     int                    refs;
     IDirectFBDataBuffer_C *iface;
};
