...
#else
		uint8_t foreignAvailability;
		uint8_t connectionType;
		uint8_t countryPrefixLength;
		uint8_t internationalAreaCodeLength;
		uint8_t operatorCodeLength;
		uint8_t nationalAreaCodeLength;
		uint8_t coreNumberLength;
#endif
