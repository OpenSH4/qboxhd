...
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr/share/snmp/mibs"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/usr/share/net-snmp"
...
#define SNMPLIBPATH "/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr/lib/snmp"
#define SNMPSHAREPATH "/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr/share/snmp"
#define SNMPCONFPATH "/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr/etc/snmp"
#define SNMPDLMODPATH "/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/var/log/net-snmp-log"
...
#define NETSNMP_CONFIGURE_OPTIONS "'--host=sh4-linux' '--build=i686-pc-linux-gnu' '--prefix=/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr' '--mandir=/var/tmp/stlinux23-sh4-netsnmp-root//opt/STM/STLinux-2.3/devkit/sh4/target//usr/share/man' '--enable-internal-md5' '--with-endianness=little' '--with-openssl=/opt/STM/STLinux-2.3/devkit/sh4/target/usr/lib' '--without-rpm' '--with-persistent-directory=/usr/share/net-snmp' '--with-logfile=/var/log/net-snmp-log' '--with-transports=UDP TCP' '--with-zlib=/opt/STM/STLinux-2.3/devkit/sh4/target/usr/lib' '--with-default-snmp-version=3' '--with-sys-contact=root@localhost' '--with-sys-location=local' '--disable-perl-cc-checks' '--disable-embedded-perl' '--without-perl-modules' 'CC=sh4-linux-gcc' 'CFLAGS=-Os' 'CXXFLAGS=-Os' 'CXX=sh4-linux-g++' 'build_alias=i686-pc-linux-gnu' 'host_alias=sh4-linux'"
