...
class eMainloop(object):
    ...
    def __init__(self, *args): 
        _enigma.eMainloop_swiginit(self,_enigma.new_eMainloop(*args))
...
class eApplication(eMainloop):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eApplication_swiginit(self,_enigma.new_eApplication(*args))
...
class iAudioTrackInfo(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.iAudioTrackInfo_swiginit(self,_enigma.new_iAudioTrackInfo(*args))
...
iRecordableServicePtr.getServiceReference = new_instancemethod(_enigma.iRecordableServicePtr_getServiceReference,None,iRecordableServicePtr)
...
class ePythonMessagePump(object):
    ...
    def __init__(self, *args): 
        _enigma.ePythonMessagePump_swiginit(self,_enigma.new_ePythonMessagePump(*args))
...
class fbClass(object):
    ...
    dfb = _swig_property(_enigma.fbClass_dfb_get, _enigma.fbClass_dfb_set)
    layer = _swig_property(_enigma.fbClass_layer_get, _enigma.fbClass_layer_set)
    primary = _swig_property(_enigma.fbClass_primary_get, _enigma.fbClass_primary_set)
    surf2 = _swig_property(_enigma.fbClass_surf2_get, _enigma.fbClass_surf2_set)
    palette = _swig_property(_enigma.fbClass_palette_get, _enigma.fbClass_palette_set)
    src_rect = _swig_property(_enigma.fbClass_src_rect_get, _enigma.fbClass_src_rect_set)
    dst_rect = _swig_property(_enigma.fbClass_dst_rect_get, _enigma.fbClass_dst_rect_set)
    ex = _swig_property(_enigma.fbClass_ex_get, _enigma.fbClass_ex_set)
    w = _swig_property(_enigma.fbClass_w_get, _enigma.fbClass_w_set)
    h = _swig_property(_enigma.fbClass_h_get, _enigma.fbClass_h_set)
fbClass.lock = new_instancemethod(_enigma.fbClass_lock,None,fbClass)
fbClass.unlock_parm = new_instancemethod(_enigma.fbClass_unlock_parm,None,fbClass)
...
fbClass.SetStretchMode = new_instancemethod(_enigma.fbClass_SetStretchMode,None,fbClass)
fbClass.dfb_grab = new_instancemethod(_enigma.fbClass_dfb_grab,None,fbClass)
fbClass.getfbResolution = new_instancemethod(_enigma.fbClass_getfbResolution,None,fbClass)
...
class gFBDC(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.gFBDC_swiginit(self,_enigma.new_gFBDC(*args))
    __swig_destroy__ = _enigma.delete_gFBDC
    getInstance = staticmethod(_enigma.gFBDC_getInstance)
gFBDC.__ref__ = new_instancemethod(_enigma.gFBDC___ref__,None,gFBDC)
gFBDC.getPtrString = new_instancemethod(_enigma.gFBDC_getPtrString,None,gFBDC)
gFBDC.__deref__ = new_instancemethod(_enigma.gFBDC___deref__,None,gFBDC)
gFBDC.setResolution = new_instancemethod(_enigma.gFBDC_setResolution,None,gFBDC)
gFBDC_swigregister = _enigma.gFBDC_swigregister
gFBDC_swigregister(gFBDC)
gFBDC_getInstance = _enigma.gFBDC_getInstance
...
class eInputContentString(eInputContent):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eInputContentString_swiginit(self,_enigma.new_eInputContentString(*args))
...
class eWidgetDesktopCompBuffer(object):
    ...
    def __init__(self, *args): 
        _enigma.eWidgetDesktopCompBuffer_swiginit(self,_enigma.new_eWidgetDesktopCompBuffer(*args))
...
class eListboxPythonConfigContent(eListboxPythonStringContent):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eListboxPythonConfigContent_swiginit(self,_enigma.new_eListboxPythonConfigContent(*args))
...
class eListboxPythonMultiContent(eListboxPythonStringContent):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eListboxPythonMultiContent_swiginit(self,_enigma.new_eListboxPythonMultiContent(*args))
...
class eWindowStyleSkinned(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eWindowStyleSkinned_swiginit(self,_enigma.new_eWindowStyleSkinned(*args))
...
class ePangoSubtitlePage(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    show_pts = _swig_property(_enigma.ePangoSubtitlePage_show_pts_get, _enigma.ePangoSubtitlePage_show_pts_set)
    ...
    def __init__(self, *args): 
        _enigma.ePangoSubtitlePage_swiginit(self,_enigma.new_ePangoSubtitlePage(*args))
...
class eListboxServiceContent(iListboxContent):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eListboxServiceContent_swiginit(self,_enigma.new_eListboxServiceContent(*args))
...
class pNavigation(iObject):
    ...
    def __init__(self, *args): 
        _enigma.pNavigation_swiginit(self,_enigma.new_pNavigation(*args))
...
eActionMap.getLastRCId = new_instancemethod(_enigma.eActionMap_getLastRCId,None,eActionMap)
...
HDMI_PCM = _enigma.HDMI_PCM
HDMI_SPDIF = _enigma.HDMI_SPDIF
AMIXER_PRIMARY = _enigma.AMIXER_PRIMARY
AMIXER_GAIN_OVERRIDE = _enigma.AMIXER_GAIN_OVERRIDE
AMIXER_SPDIF_ENCODING = _enigma.AMIXER_SPDIF_ENCODING
AMIXER_SPDIF_BYPASS = _enigma.AMIXER_SPDIF_BYPASS
class eDVBVolumecontrol(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    instance = _swig_property(_enigma.eDVBVolumecontrol_instance_get, _enigma.eDVBVolumecontrol_instance_set)
...
MPEG_TYPE_VOLUME = _enigma.MPEG_TYPE_VOLUME
AC3_TYPE_VOLUME = _enigma.AC3_TYPE_VOLUME
RADIO_TYPE_VOLUME = _enigma.RADIO_TYPE_VOLUME
amixer_control_set = _enigma.amixer_control_set
setVolumeAudioType = _enigma.setVolumeAudioType
...
class eDVBFrontendParametersSatellite(object):
    ...
    def __init__(self, *args): 
        _enigma.eDVBFrontendParametersSatellite_swiginit(self,_enigma.new_eDVBFrontendParametersSatellite(*args))
...
class eDVBFrontendParametersCable(object):
    ...
    def __init__(self, *args): 
        _enigma.eDVBFrontendParametersCable_swiginit(self,_enigma.new_eDVBFrontendParametersCable(*args))
...
class eDVBFrontendParametersTerrestrial(object):
    ...
    def __init__(self, *args): 
        _enigma.eDVBFrontendParametersTerrestrial_swiginit(self,_enigma.new_eDVBFrontendParametersTerrestrial(*args))
...
class eDVBDiseqcCommand(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eDVBDiseqcCommand_swiginit(self,_enigma.new_eDVBDiseqcCommand(*args))
...
class eDVBFrontendParameters(iDVBFrontendParameters):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eDVBFrontendParameters_swiginit(self,_enigma.new_eDVBFrontendParameters(*args))
...
class eComponentScan(iObject):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eComponentScan_swiginit(self,_enigma.new_eComponentScan(*args))
...
LETTERBOX = _enigma.LETTERBOX
NONLINEAR = _enigma.NONLINEAR
PANeSCAN = _enigma.PANeSCAN
BESTFIT = _enigma.BESTFIT
V_4_3 = _enigma.V_4_3
V_16_9 = _enigma.V_16_9
class Format_video_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    aspect_ratio = _swig_property(_enigma.Format_video_t_aspect_ratio_get, _enigma.Format_video_t_aspect_ratio_set)
    policy = _swig_property(_enigma.Format_video_t_policy_get, _enigma.Format_video_t_policy_set)
    def __init__(self, *args): 
        _enigma.Format_video_t_swiginit(self,_enigma.new_Format_video_t(*args))
    __swig_destroy__ = _enigma.delete_Format_video_t
Format_video_t_swigregister = _enigma.Format_video_t_swigregister
Format_video_t_swigregister(Format_video_t)

set_scart_aspect = _enigma.set_scart_aspect
...
eAVSwitch.setFastBlank = new_instancemethod(_enigma.eAVSwitch_setFastBlank,None,eAVSwitch)
eAVSwitch.disable_scart_hdmi = new_instancemethod(_enigma.eAVSwitch_disable_scart_hdmi,None,eAVSwitch)
...
DISPLAY_WIDTH = _enigma.DISPLAY_WIDTH
DISPLAY_HEIGHT = _enigma.DISPLAY_HEIGHT
DISPLAY_WIDTH_MINI = _enigma.DISPLAY_WIDTH_MINI
DISPLAY_HEIGHT_MINI = _enigma.DISPLAY_HEIGHT_MINI
LCD_DEVICE_NAME = _enigma.LCD_DEVICE_NAME
LCD_IOC_MAGIC = _enigma.LCD_IOC_MAGIC
LCD_IOC_NR = _enigma.LCD_IOC_NR
BRIGHTNESS_OFF = _enigma.BRIGHTNESS_OFF
BRIGHTNESS_ON = _enigma.BRIGHTNESS_ON
LCD_STOP = _enigma.LCD_STOP
LCD_START = _enigma.LCD_START
class eLCD(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
...
eLCD.enable_update = new_instancemethod(_enigma.eLCD_enable_update,None,eLCD)
eLCD.draw = new_instancemethod(_enigma.eLCD_draw,None,eLCD)
eLCD_swigregister = _enigma.eLCD_swigregister
eLCD_swigregister(eLCD)

NO_INIT = _enigma.NO_INIT
INIT = _enigma.INIT
SUSPEND = _enigma.SUSPEND
suspend_display_dfb = _enigma.suspend_display_dfb
class DFB_Surface_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    surf = _swig_property(_enigma.DFB_Surface_t_surf_get, _enigma.DFB_Surface_t_surf_set)
    surface_pitch = _swig_property(_enigma.DFB_Surface_t_surface_pitch_get, _enigma.DFB_Surface_t_surface_pitch_set)
    surface_data = _swig_property(_enigma.DFB_Surface_t_surface_data_get, _enigma.DFB_Surface_t_surface_data_set)
    pBUFF = _swig_property(_enigma.DFB_Surface_t_pBUFF_get, _enigma.DFB_Surface_t_pBUFF_set)
    def __init__(self, *args): 
        _enigma.DFB_Surface_t_swiginit(self,_enigma.new_DFB_Surface_t(*args))
    __swig_destroy__ = _enigma.delete_DFB_Surface_t
DFB_Surface_t_swigregister = _enigma.DFB_Surface_t_swigregister
DFB_Surface_t_swigregister(DFB_Surface_t)

class DFB_Stretch_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    init_struct = _swig_property(_enigma.DFB_Stretch_t_init_struct_get, _enigma.DFB_Stretch_t_init_struct_set)
    dfb = _swig_property(_enigma.DFB_Stretch_t_dfb_get, _enigma.DFB_Stretch_t_dfb_set)
    layer = _swig_property(_enigma.DFB_Stretch_t_layer_get, _enigma.DFB_Stretch_t_layer_set)
    primary = _swig_property(_enigma.DFB_Stretch_t_primary_get, _enigma.DFB_Stretch_t_primary_set)
    surf2 = _swig_property(_enigma.DFB_Stretch_t_surf2_get, _enigma.DFB_Stretch_t_surf2_set)
    surf3 = _swig_property(_enigma.DFB_Stretch_t_surf3_get, _enigma.DFB_Stretch_t_surf3_set)
    src_rect = _swig_property(_enigma.DFB_Stretch_t_src_rect_get, _enigma.DFB_Stretch_t_src_rect_set)
    dst_rect = _swig_property(_enigma.DFB_Stretch_t_dst_rect_get, _enigma.DFB_Stretch_t_dst_rect_set)
    dsc = _swig_property(_enigma.DFB_Stretch_t_dsc_get, _enigma.DFB_Stretch_t_dsc_set)
    def __init__(self, *args): 
        _enigma.DFB_Stretch_t_swiginit(self,_enigma.new_DFB_Stretch_t(*args))
    __swig_destroy__ = _enigma.delete_DFB_Stretch_t
DFB_Stretch_t_swigregister = _enigma.DFB_Stretch_t_swigregister
DFB_Stretch_t_swigregister(DFB_Stretch_t)
...
class eDBoxLCD(eLCD):
    ...
    buff_mmap = _swig_property(_enigma.eDBoxLCD_buff_mmap_get, _enigma.eDBoxLCD_buff_mmap_set)
eDBoxLCD.deinit_DFB_for_display = new_instancemethod(_enigma.eDBoxLCD_deinit_DFB_for_display,None,eDBoxLCD)
...
eDBoxLCD.DrawRGB565 = new_instancemethod(_enigma.eDBoxLCD_DrawRGB565,None,eDBoxLCD)
...
HOLTEK_DEV = _enigma.HOLTEK_DEV
IOCTL_LPC_MAGIC = _enigma.IOCTL_LPC_MAGIC
class Rrgb_Value_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    red = _swig_property(_enigma.Rrgb_Value_t_red_get, _enigma.Rrgb_Value_t_red_set)
    green = _swig_property(_enigma.Rrgb_Value_t_green_get, _enigma.Rrgb_Value_t_green_set)
    blue = _swig_property(_enigma.Rrgb_Value_t_blue_get, _enigma.Rrgb_Value_t_blue_set)
    def __init__(self, *args): 
        _enigma.Rrgb_Value_t_swiginit(self,_enigma.new_Rrgb_Value_t(*args))
    __swig_destroy__ = _enigma.delete_Rrgb_Value_t
Rrgb_Value_t_swigregister = _enigma.Rrgb_Value_t_swigregister
Rrgb_Value_t_swigregister(Rrgb_Value_t)

class Global_Status_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    clr = _swig_property(_enigma.Global_Status_t_clr_get, _enigma.Global_Status_t_clr_set)
    button = _swig_property(_enigma.Global_Status_t_button_get, _enigma.Global_Status_t_button_set)
    def __init__(self, *args): 
        _enigma.Global_Status_t_swiginit(self,_enigma.new_Global_Status_t(*args))
    __swig_destroy__ = _enigma.delete_Global_Status_t
Global_Status_t_swigregister = _enigma.Global_Status_t_swigregister
Global_Status_t_swigregister(Global_Status_t)

class eQBOXFrontButton(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    getInstance = staticmethod(_enigma.eQBOXFrontButton_getInstance)
eQBOXFrontButton.lock = new_instancemethod(_enigma.eQBOXFrontButton_lock,None,eQBOXFrontButton)
eQBOXFrontButton.unlock = new_instancemethod(_enigma.eQBOXFrontButton_unlock,None,eQBOXFrontButton)
eQBOXFrontButton.detected = new_instancemethod(_enigma.eQBOXFrontButton_detected,None,eQBOXFrontButton)
eQBOXFrontButton.islocked = new_instancemethod(_enigma.eQBOXFrontButton_islocked,None,eQBOXFrontButton)
eQBOXFrontButton.setLed = new_instancemethod(_enigma.eQBOXFrontButton_setLed,None,eQBOXFrontButton)
eQBOXFrontButton.enterDeepStandby = new_instancemethod(_enigma.eQBOXFrontButton_enterDeepStandby,None,eQBOXFrontButton)
eQBOXFrontButton.enterStandby = new_instancemethod(_enigma.eQBOXFrontButton_enterStandby,None,eQBOXFrontButton)
eQBOXFrontButton.leaveStandby = new_instancemethod(_enigma.eQBOXFrontButton_leaveStandby,None,eQBOXFrontButton)
eQBOXFrontButton_swigregister = _enigma.eQBOXFrontButton_swigregister
eQBOXFrontButton_swigregister(eQBOXFrontButton)
eQBOXFrontButton_getInstance = _enigma.eQBOXFrontButton_getInstance
...
eDVBCIInterfaces.rst_all_modules = new_instancemethod(_enigma.eDVBCIInterfaces_rst_all_modules,None,eDVBCIInterfaces)
...
DELAYER_DEVICE_NAME = _enigma.DELAYER_DEVICE_NAME
DELAYER_MAJOR_NUM = _enigma.DELAYER_MAJOR_NUM
DELAYER_MINOR_START = _enigma.DELAYER_MINOR_START
class DelayerEn(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    enable = _swig_property(_enigma.DelayerEn_enable_get, _enigma.DelayerEn_enable_set)
    dvbAdapter = _swig_property(_enigma.DelayerEn_dvbAdapter_get, _enigma.DelayerEn_dvbAdapter_set)
    delay = _swig_property(_enigma.DelayerEn_delay_get, _enigma.DelayerEn_delay_set)
    def __init__(self, *args): 
        _enigma.DelayerEn_swiginit(self,_enigma.new_DelayerEn(*args))
    __swig_destroy__ = _enigma.delete_DelayerEn
DelayerEn_swigregister = _enigma.DelayerEn_swigregister
DelayerEn_swigregister(DelayerEn)

IOCTL_DELAYER_MAGIC = _enigma.IOCTL_DELAYER_MAGIC
class eDelayerAdapter(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eDelayerAdapter_swiginit(self,_enigma.new_eDelayerAdapter(*args))
    __swig_destroy__ = _enigma.delete_eDelayerAdapter
eDelayerAdapter.getAdapter = new_instancemethod(_enigma.eDelayerAdapter_getAdapter,None,eDelayerAdapter)
eDelayerAdapter.getDelayTime = new_instancemethod(_enigma.eDelayerAdapter_getDelayTime,None,eDelayerAdapter)
eDelayerAdapter.setDelayTime = new_instancemethod(_enigma.eDelayerAdapter_setDelayTime,None,eDelayerAdapter)
eDelayerAdapter.isActive = new_instancemethod(_enigma.eDelayerAdapter_isActive,None,eDelayerAdapter)
eDelayerAdapter_swigregister = _enigma.eDelayerAdapter_swigregister
eDelayerAdapter_swigregister(eDelayerAdapter)

class eDelayerManager(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.eDelayerManager_swiginit(self,_enigma.new_eDelayerManager(*args))
    __swig_destroy__ = _enigma.delete_eDelayerManager
    evDelayNoActive = _enigma.eDelayerManager_evDelayNoActive
    evDelayActive = _enigma.eDelayerManager_evDelayActive
    delayerStateChanged = _swig_property(_enigma.eDelayerManager_delayerStateChanged_get)
    getInstance = staticmethod(_enigma.eDelayerManager_getInstance)
eDelayerManager.addDelayerAdapter = new_instancemethod(_enigma.eDelayerManager_addDelayerAdapter,None,eDelayerManager)
eDelayerManager.getDelayerAdapter = new_instancemethod(_enigma.eDelayerManager_getDelayerAdapter,None,eDelayerManager)
eDelayerManager_swigregister = _enigma.eDelayerManager_swigregister
eDelayerManager_swigregister(eDelayerManager)
eDelayerManager_getInstance = _enigma.eDelayerManager_getInstance
...
class ePicLoad(eMainloop,iObject):
    ...
    def __init__(self, *args): 
        _enigma.ePicLoad_swiginit(self,_enigma.new_ePicLoad(*args))
...
class PSignal0V(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.PSignal0V_swiginit(self,_enigma.new_PSignal0V(*args))
...
class PSignal1VI(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.PSignal1VI_swiginit(self,_enigma.new_PSignal1VI(*args))
...
class PSignal1VS(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.PSignal1VS_swiginit(self,_enigma.new_PSignal1VS(*args))
...
class PSignal2VoidIRecordableServiceInt(object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.PSignal2VoidIRecordableServiceInt_swiginit(self,_enigma.new_PSignal2VoidIRecordableServiceInt(*args))
...
class PSignal2VoidIntInt(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _enigma.PSignal2VoidIntInt_swiginit(self,_enigma.new_PSignal2VoidIntInt(*args))
    __swig_destroy__ = _enigma.delete_PSignal2VoidIntInt
PSignal2VoidIntInt.get = new_instancemethod(_enigma.PSignal2VoidIntInt_get,None,PSignal2VoidIntInt)
PSignal2VoidIntInt_swigregister = _enigma.PSignal2VoidIntInt_swigregister
PSignal2VoidIntInt_swigregister(PSignal2VoidIntInt)
