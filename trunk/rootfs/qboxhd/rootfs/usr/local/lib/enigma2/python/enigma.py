...
LED_MAGIC = _enigma.LED_MAGIC
class eQBOXSenseWheel(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    getInstance = staticmethod(_enigma.eQBOXSenseWheel_getInstance)
eQBOXSenseWheel.lock = new_instancemethod(_enigma.eQBOXSenseWheel_lock,None,eQBOXSenseWheel)
eQBOXSenseWheel.unlock = new_instancemethod(_enigma.eQBOXSenseWheel_unlock,None,eQBOXSenseWheel)
eQBOXSenseWheel.detected = new_instancemethod(_enigma.eQBOXSenseWheel_detected,None,eQBOXSenseWheel)
eQBOXSenseWheel.islocked = new_instancemethod(_enigma.eQBOXSenseWheel_islocked,None,eQBOXSenseWheel)
eQBOXSenseWheel.setDisableSense = new_instancemethod(_enigma.eQBOXSenseWheel_setDisableSense,None,eQBOXSenseWheel)
eQBOXSenseWheel.setEnableSense = new_instancemethod(_enigma.eQBOXSenseWheel_setEnableSense,None,eQBOXSenseWheel)
eQBOXSenseWheel.setLedsPanel = new_instancemethod(_enigma.eQBOXSenseWheel_setLedsPanel,None,eQBOXSenseWheel)
eQBOXSenseWheel.setLedsBoard = new_instancemethod(_enigma.eQBOXSenseWheel_setLedsBoard,None,eQBOXSenseWheel)
eQBOXSenseWheel.enterStandby = new_instancemethod(_enigma.eQBOXSenseWheel_enterStandby,None,eQBOXSenseWheel)
eQBOXSenseWheel.leaveStandby = new_instancemethod(_enigma.eQBOXSenseWheel_leaveStandby,None,eQBOXSenseWheel)
eQBOXSenseWheel.setStandbyOnPanel = new_instancemethod(_enigma.eQBOXSenseWheel_setStandbyOnPanel,None,eQBOXSenseWheel)
eQBOXSenseWheel.isSetStandbyOnPanel = new_instancemethod(_enigma.eQBOXSenseWheel_isSetStandbyOnPanel,None,eQBOXSenseWheel)
eQBOXSenseWheel_swigregister = _enigma.eQBOXSenseWheel_swigregister
eQBOXSenseWheel_swigregister(eQBOXSenseWheel)
eQBOXSenseWheel_getInstance = _enigma.eQBOXSenseWheel_getInstance
