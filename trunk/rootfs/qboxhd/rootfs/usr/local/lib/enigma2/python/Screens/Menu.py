...
class MenuSummary(Screen):
	if QBOXHD:
		skin = """
		<screen name="MenuSummary" position="0,0" size="320,240">
			<widget source="parent.title" render="Label" position="6,55" size="300,40" font="Regular;35" halign="center" valign="center"/>
			<widget source="parent.menu" render="Label" position="6,90" size="300,120" font="Regular;46" halign="center" valign="center">
...
class Menu(Screen):
	...
	def removeNotifier(self):
		menumanager.on_menu_change.remove(self.menuChanged)
	
		
	def menuChanged(self):
		list = []
		self.refreshMenu(list)
		self["menu"].setList(list)
		
	
	def refreshMenu(self, list):
		menuID = None
		for x in self.parent:						#walk through the actual nodelist
			if x.tag == 'item':
	...
	def __init__(self, session, parent):
		...
		if QBOXHD:
			self.parent = parent
			menumanager.on_menu_change.append(self.menuChanged)
