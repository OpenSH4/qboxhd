...
#			dump(self.current_dialog)
	...
	def open(self, screen, *arguments, **kwargs):
		# This gives problem with the modal screen that shows when the CAM is detected
		if not QBOXHD:
...
if not QBOXHD_MINI:
	profile("SENSEWHEEL")
	import Components.SenseWheel
	Components.SenseWheel.InitSenseWheel()
#endif QBOXHD

#if QBOXHD
if QBOXHD_MINI:
	profile("DELAYER")
	import Components.Delayer
	Components.Delayer.InitDelayer()
#endif QBOXHD

#if QBOXHD
if QBOXHD_MINI:
	profile("FrontButton")
	import Components.FrontButton
	Components.FrontButton.InitFrontButton()
#endif QBOXHD
