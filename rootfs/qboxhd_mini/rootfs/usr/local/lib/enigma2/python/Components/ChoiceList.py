...
def ChoiceEntryComponent(key, text):
	...
	if text[0] == "--":
		if QBOXHD:
			res.append((eListboxPythonMultiContent.TYPE_TEXT, 0, 00, 600, 25, 0, RT_HALIGN_LEFT, "-"*200))
		else:
			res.append((eListboxPythonMultiContent.TYPE_TEXT, 0, 00, 800, 25, 0, RT_HALIGN_LEFT, "-"*200))
	else:
		if QBOXHD:
			res.append((eListboxPythonMultiContent.TYPE_TEXT, 45, 00, 600, 25, 0, RT_HALIGN_LEFT, text[0]))
		else:
