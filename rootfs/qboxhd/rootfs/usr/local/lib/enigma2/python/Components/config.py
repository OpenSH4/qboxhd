...
class ConfigElement(object):
	...
	def addNotifierSave(self, notifier, initial_call = True):
		assert callable(notifier), "notifiers must be callable"
		self.save_notifiers.append(notifier)
	...
	def addNotifierLoad(self, notifier, initial_call = True):
		assert callable(notifier), "notifiers must be callable"
		self.load_notifiers.append(notifier)
