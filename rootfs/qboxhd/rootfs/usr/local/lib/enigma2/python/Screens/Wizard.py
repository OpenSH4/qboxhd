...
class WizardSummary(Screen):
	if QBOXHD:
		...
		<screen position="0,0" size="320,240">
			<widget name="text" position="15,15" size="290,157" font="Regular;30" transparent="1" />
			<widget source="parent.list" render="Label" position="15,93" size="290,78" font="Regular;32">
