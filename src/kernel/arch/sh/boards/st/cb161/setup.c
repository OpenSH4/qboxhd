...
const char *LMI_VID2_partalias[] = { "gfx-memory-0", NULL };
const char *LMI_VID3_partalias[] = { "gfx-memory-1", NULL };
const char *LMI_VID4_partalias[] = { "coredisplay-video", NULL };
const char *LMI_SYS_partalias [] = { "BPA2_Region0", "bigphysarea", "v4l2-coded-video-buffers", NULL };

static struct bpa2_partition_desc bpa2_parts_table[] = {
	{
		.name  = "LMI_VID_CORE_DISPLAY",
		.start = 0x81000000,
		.size  = 0x00400000,
		.flags = 0,
        	.aka   = LMI_VID4_partalias
	},
	{
...
static void __init dvo_init(void)
{
