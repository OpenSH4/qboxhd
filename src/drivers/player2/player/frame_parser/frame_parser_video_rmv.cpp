...
FrameParserStatus_t   FrameParser_VideoRmv_c::RevPlayGeneratePostDecodeParameterSettings (void)
{
    //
...
FrameParserStatus_t   FrameParser_VideoRmv_c::RevPlayRemoveReferenceFrameFromList (void)
{
    bool        LastField;
