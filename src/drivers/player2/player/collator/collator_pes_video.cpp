...
//
	...
	if( GotPartialZeroHeader )
	{
		...
		if ((StoredZeroHeader+GotPartialZeroHeaderBytes-BufferBase)+Transfer > MaximumCodedFrameSize)            //Fixed by Duolabs
		{
			//report( severity_error, "Collator_Base_c::Buffer Overflow 1\n" );
...
#if defined CONFIG_SH_QBOXHD_1_0 || defined CONFIG_SH_QBOXHD_MINI_1_0
		if ((StoredPesHeader+GotPartialPesHeaderBytes-BufferBase)+Transfer > MaximumCodedFrameSize)	//Fixed by Duolabs
		{
			//report( severity_error, "Collator_Base_c::Buffer Overflow 2\n" );
            DiscardAccumulatedData();
            return CollatorBufferOverflow;
		}
#endif
...
#if defined CONFIG_SH_QBOXHD_1_0 || defined CONFIG_SH_QBOXHD_MINI_1_0
		if ((StoredPaddingHeader+GotPartialPaddingHeaderBytes-BufferBase)+Transfer > MaximumCodedFrameSize)     //Fixed by Duolabs
		{
			//report( severity_error, "Collator_Base_c::Buffer Overflow 3\n" );
			DiscardAccumulatedData();
			return CollatorBufferOverflow;
		}
#endif
