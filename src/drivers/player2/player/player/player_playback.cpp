...
//
	...
	report( severity_info, "Player_Generic_c::AddStream - added NewStream=<%p> to Playback->ListOfStreams=<%p>.\n",NewStream,NewStream->Next);
	OS_UnLockMutex( &Lock );
...
report( severity_info, "Player_Generic_c::RemoveStream - Stream=<%p>.\n",Stream );
	//
