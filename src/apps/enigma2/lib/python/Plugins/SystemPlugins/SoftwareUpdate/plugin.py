...
class UpdatePluginMenu(Screen):
	...
	def runFinished(self):
		self.session.openWithCallback(self.reboot, MessageBox, _("Upgrade finished. Do you want to reboot your QBoxHD?"), MessageBox.TYPE_YESNO)
...
class Ipkg2(Screen):
	...
	def go(self):
		if self.update:
			self.session.openWithCallback(self.doUpdate, MessageBox, _("Do you want to update your QBoxHD?\nAfter pressing OK, please wait!"))		
		else:
			self.close()
	...
	def exit(self):
		if not self.ipkg.isRunning():
			if self.packages != 0 and self.error == 0:
				self.session.openWithCallback(self.exitAnswer, MessageBox, _("Upgrade finished. Do you want to reboot your QBoxHD?"))
			else:
				self.close()
