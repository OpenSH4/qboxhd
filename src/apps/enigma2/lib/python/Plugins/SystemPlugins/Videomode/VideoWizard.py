...
class VideoWizardSummary(WizardSummary):
	...
	<screen position="0,0" size="320,240">
		<widget name="text" position="15,15" size="290,158" font="Regular;30" transparent="1" />
		<widget source="parent.list" render="Label" position="15,93" size="290,79" font="Regular;32">
