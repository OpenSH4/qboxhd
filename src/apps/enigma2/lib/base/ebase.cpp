...
void eBaseInit(void)
{
	...
	{
#ifdef QBOXHD
        Org_Py_INCREF((PyObject*)(void *)&eTimerPyType);
        PyModule_AddObject(m, "eTimer", (PyObject*)(void *)&eTimerPyType);
#else
	...
	{
#ifdef QBOXHD
        Org_Py_INCREF((PyObject*)(void *)&eSocketNotifierPyType);
        PyModule_AddObject(m, "eSocketNotifier", (PyObject*)(void *)&eSocketNotifierPyType);
#else
