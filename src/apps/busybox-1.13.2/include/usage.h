...
#define mtd_md5sum_trivial_usage \
       "if=<mtd_device> [length=<data_length>]"

#define mtd_md5sum_full_usage "\n\n" \
     "\nOptions:" \
     "\n	if=<mtd_device>" \
     "\n	length=<length>"

#define mtd_md5sum_example_usage \
       "$ mtd_md5sum if=/file\n" \
       "$ mtd_md5sum if=/file length=50000\n" \
       "$ mtd_md5sum if=/dev/mtd4\n" \
       "$ mtd_md5sum if=/dev/mtd4 length=50000\n"
